...
- **`src/`**: Source root containing `AndroidManifest.xml` (manifest with permissions and services), Kotlin source files in `main/kotlin/`, and launcher resources in `main/res/`.
