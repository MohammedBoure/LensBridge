...
- **Concurrent Dual Camera Broadcasting**: Simultaneously streams frames from the rear camera and front selfie camera.
...
- **Telemetry and Controls**: Real-time FPS metrics, Wi-Fi status badges, hardware capability indicators, and manual IP override settings.
